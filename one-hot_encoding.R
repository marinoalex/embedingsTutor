...
samplesChar <- c("The cat sat on the mat.", "The dog ate my homework.")
...
results <- array(0, dim = c(length(samplesChar), max_length, length(token_index)))

for (i in 1:length(samplesChar)) {
  sample <- samplesChar[[i]]
